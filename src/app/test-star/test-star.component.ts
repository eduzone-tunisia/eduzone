...
export class TestStarComponent  {
  courseId :any
    ...
    constructor(private snackBar: MatSnackBar , private sharedService : SharedService , private cousesService : CousesService ) { }
    ...
    countStar(star: number | undefined) {
      ...
      console.log('selected', this.selectedValue)
       this.cousesService.updateCourseRating(this.courseId, {rating : this.selectedValue}).subscribe( res => {
         console.log(res)
       })
